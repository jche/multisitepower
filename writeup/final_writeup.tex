...
We therefore simulate data using $\alpha = 0.175$, $\sigma_\alpha=0.01$, and $\tau=0.03$, and use a variety of possible values for $\sigma_\tau$ and $\rho_{01}$.
...
Figure asdf shows the results.

Just show the figure with different sigma_tau values...?

We can expect poor precision...
